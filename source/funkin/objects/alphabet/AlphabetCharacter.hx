...
class AlphabetCharacter extends FlxSpriteExt
{
	...
	public static var characters:Map<String, Null<LetterData>> = [
		//  Alphabet
		"a" => {offsetBold: [0, 0], offsetLowerNormal: [0, 10], offsetUpperNormal: [0, 0]},
		"b" => {offsetBold: [0, 0], offsetLowerNormal: [0, 0], offsetUpperNormal: [0, 0]},
		"c" => {offsetBold: [0, 0], offsetLowerNormal: [0, 15], offsetUpperNormal: [0, 0]},
		"d" => {offsetBold: [0, 0], offsetLowerNormal: [0, 0], offsetUpperNormal: [0, 0]},
		"e" => {offsetBold: [0, 0], offsetLowerNormal: [0, 15], offsetUpperNormal: [0, 0]},
		"f" => {offsetBold: [0, 0], offsetLowerNormal: [0, 0], offsetUpperNormal: [0, 0]},
		"g" => {offsetBold: [0, 3], offsetLowerNormal: [0, 17], offsetUpperNormal: [0, 0]},
		"h" => {offsetBold: [0, 0], offsetLowerNormal: [0, 5], offsetUpperNormal: [0, 0]},
		"i" => {offsetBold: [0, 0], offsetLowerNormal: [0, 10], offsetUpperNormal: [0, 0]},
		"j" => {offsetBold: [0, 0], offsetLowerNormal: [0, 5], offsetUpperNormal: [0, 0]},
		"k" => {offsetBold: [0, 0], offsetLowerNormal: [0, 5], offsetUpperNormal: [0, 0]},
		"l" => {offsetBold: [0, 0], offsetLowerNormal: [0, 5], offsetUpperNormal: [0, 0]},
		"m" => {offsetBold: [0, 3], offsetLowerNormal: [0, 25], offsetUpperNormal: [0, 0]},
		"n" => {offsetBold: [0, 0], offsetLowerNormal: [0, 25], offsetUpperNormal: [0, 0]},
		"o" => {offsetBold: [0, 0], offsetLowerNormal: [0, 20], offsetUpperNormal: [0, 0]},
		"p" => {offsetBold: [0, 0], offsetLowerNormal: [0, 20], offsetUpperNormal: [0, 0]},
		"q" => {offsetBold: [0, 0], offsetLowerNormal: [0, 20], offsetUpperNormal: [0, 0]},
		"r" => {offsetBold: [0, 0], offsetLowerNormal: [0, 20], offsetUpperNormal: [0, 0]},
		"s" => {offsetBold: [0, 0], offsetLowerNormal: [0, 15], offsetUpperNormal: [0, 0]},
		"t" => {offsetBold: [0, 0], offsetLowerNormal: [0, 5], offsetUpperNormal: [0, 0]},
		"u" => {offsetBold: [0, 7], offsetLowerNormal: [0, 20], offsetUpperNormal: [0, 0]},
		"v" => {offsetBold: [0, 0], offsetLowerNormal: [0, 15], offsetUpperNormal: [0, 0]},
		"w" => {offsetBold: [0, 3], offsetLowerNormal: [0, 20], offsetUpperNormal: [0, 0]},
		"x" => {offsetBold: [0, 0], offsetLowerNormal: [0, 10], offsetUpperNormal: [0, 0]},
		"y" => {offsetBold: [0, 0], offsetLowerNormal: [0, 10], offsetUpperNormal: [0, 0]},
		"z" => {offsetBold: [0, 0], offsetLowerNormal: [0, 10], offsetUpperNormal: [0, 0]},
		//  Numbers
		"1" => null,
		"2" => null,
		"3" => null,
		...
		"^" => null,
		"_" => null,
		"." => {specialPrefix: "period", offsetBold: [0, 50], offsetLowerNormal: [0, 40]},
		"," => {specialPrefix: "comma", offsetLowerNormal: [0, 40]},
		"'" => {specialPrefix: "apostrophe"},
		"!" => {specialPrefix: "exclamation", offsetBold: [0, -10]},
