...
class ModdingUtil
{
	...
	private static var folderExceptions:Array<String> = ['data', 'fonts', 'images', 'music', 'songs', 'sounds'];
	...
	public static function getScriptList(folder:String = 'data/scripts/global', assets:Bool = true, globalMod:Bool = true, curMod:Bool = true,
			allMods:Bool = false):Array<String>
	{
