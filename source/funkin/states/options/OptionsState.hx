...
class OptionsState extends MusicBeatState
{
	...
	function openOptions():Void
	{
		...
		{
			case 'Preferences':
				switchState(new funkin.states.options.PreferencesState());
			case 'Controls':
				switchState(new funkin.states.options.ControlsState());
			// case 'Note Colors':	FlxG.switchState(new funkin.states.options.NoteColorState());
			case 'Latency':
				switchState(new funkin.states.options.LatencyState());
			case 'Mod Folders':
				switchState(new funkin.states.options.ModFoldersState());
			default:
				exitOptions();
		}
	}
