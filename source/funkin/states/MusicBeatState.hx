...
class MusicBeatState extends FlxUIState
{
	...
	public function getPref(pref:String):Dynamic
	...
	{
		if (!CustomTransition.skipTrans)
			openSubState(new TransitionSubstate());
...
class TransitionSubstate extends FlxSubState
{
	override function update(elapsed:Float)
	{
		...
		if (MusicBeatState.game == null)
			return;
		if (MusicBeatState.game.transition == null)
			return;
