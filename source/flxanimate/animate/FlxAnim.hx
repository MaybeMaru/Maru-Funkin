...
class FlxAnim implements IFlxDestroyable
{
	...
	**/
	 ...
	 * @param FrameRate the framerate of the animation.
	 */
	public function addByAnimIndices(Name:String, Indices:Array<Int>, FrameRate:Float = 0, Looped:Bool = false)
	{
		addBySymbolIndices(Name, stageInstance.symbol.name, Indices, FrameRate, Looped, 0,0);
	}
