		...
		for (type in graphics.__commands.types)
		{
			switch (type)
			{
				...
				case BEGIN_SHADER_FILL:
					...
					{
						var i:Int = 0;
						var l:Int = shaderBuffer.inputCount;
						while (i < l)
						{
							...
							if (bitmap != null)
							{
								...
								while (quadBufferPosition < end)
								{
									...
									if (shader.__position != null) {
                                        context.setVertexBufferAt(shader.__position.index, graphics.__quadBuffer.vertexBuffer,
                                            quadBufferPosition * 16, FLOAT_2);
                                    }

									
                                    if (shader.__textureCoord != null) {
                                        context.setVertexBufferAt(shader.__textureCoord.index, graphics.__quadBuffer.vertexBuffer,
